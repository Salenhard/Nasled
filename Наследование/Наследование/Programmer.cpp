...
void Programmer::set_level(Levels new_level)						// устанавливает уровень программиста
{
	if (new_level != -1)
...
void Programmer::set_language(Languages new_language)				// устанавливает язык программирования
{
	if (new_language != -1)
...
Programmer::Programmer(const Levels new_level, const Languages new_language, int new_wage, int new_employee_id, int new_experience, const std::string& new_name, const std::string& new_secondname, const std::string& new_lastname, int new_day, int new_month, int new_year)		// конструктор с параметрами
{
	set_props(new_level, new_language, new_experience, new_wage, new_employee_id, new_name, new_secondname, new_lastname, new_day, new_month, new_year);
}

void Programmer::set_props(const Levels new_level, const Languages new_language, int new_wage, int new_employee_id, int new_experience, const std::string& new_name, const std::string& new_secondname, const std::string& new_lastname, int new_day, int new_month, int new_year)	// устанавливает все параметры
{
	...
	set_date_of_birth(new_day, new_month, new_year);
}
