...
Employee::Employee(int new_wage, int new_employee_id, const std::string& new_name, const std::string& new_secondname, const std::string& new_lastname, int new_day, int new_month, int new_year)					// конструктор с параметрами
{
	set_props(new_wage, new_employee_id, new_name, new_secondname, new_lastname, new_day, new_month, new_year);
}

void  Employee::set_props(int new_wage, int new_employee_id, const std::string& new_name, const std::string& new_secondname, const std::string& new_lastname, int new_day, int new_month, int new_year)			// устанавливает все поля класса
{
